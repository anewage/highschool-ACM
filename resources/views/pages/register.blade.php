...
@section('content')
    ...
    <section class="wrapper style1 special fade-up">
        ...
        <span>نام تیم:</span>{{ Form::text('teamName', null, ['class' => '6u 12u$(xsmall)', 'placeholder' => 'اسم تیم خود را اینجا وارد کنید']) }}
        <br>
        <span>نام دبیرستان:</span>{{ Form::text('highschool', null, ['class' => '6u 12u$(xsmall)', 'placeholder' => 'نام دبیرستان خود را اینجا وارد کنید']) }}
        <br>
        {{ Form::label('MemberNames', 'اطلاعات شرکت‌کنندگان', ['class' => 'title']) }}
        {{ Form::label('mem1Props', 'عضو اول', ['style' => 'margin-top: 30px']) }}<br>
        <span>نام و نام خانوادگی عضو اول تیم:</span>{{ Form::text('p1Name', null, ['class' => '6u 12u$(xsmall)', 'placeholder' => 'نام و نام خانوادگی عضو اول تیم']) }}
        <br>
        <span>شماره تماس عضو اول تیم:</span>{{ Form::text('p1Phone', null, ['class' => '6u 12u$(xsmall)', 'placeholder' => 'شماره تلفن عضو اول تیم']) }}
        <br>
        ...
        {{ Form::label('coachInfo', 'اطلاعات سرئرست تیم (الزاماً باید یکی از اعضای کادر دبیرستان باشد)',['style' => 'margin-top: 30px', 'class' => 'title']) }}
